...
!yus Include tuned liquid column damper degrees of freedom.
!yus mal Make the x-direction TLCD the 25th DOF, and the y-direction TLCD the 26th DOF
INTEGER(4), PARAMETER        :: DOF_TlcdX = 16                                   ! DOF index for axial TLCD.
INTEGER(4), PARAMETER        :: DOF_TlcdY = 17                                   ! DOF index for transverse TLCD.
...
!yus Start of proposed change. 1-Dec-2014.
!yus create number of DOF variables for the TLCDs and pointer arrays
INTEGER(4)                   :: NPTlcdXE                                         ! Number of DOFs                  that contribute to the QD2T-related linear accelerations of the TlcdX center of mass                                                          (point U) in the inertia frame, based on which DOFs are presently enabled.
...
!yus Start of proposed change.  1-Dec-2014.
!yus Add feature for modeling two TLCDs in the nacelle.
LOGICAL                   :: TlcdXDOF   = .FALSE.                             ! Axial TLCD DOF. (Initialize to .FALSE. b/c not all models will use a TLCD)
LOGICAL                   :: TlcdYDOF   = .FALSE.                             ! Transverse TLCD DOF. (Initialize to .FALSE. b/c not all models will use a TLCD)
