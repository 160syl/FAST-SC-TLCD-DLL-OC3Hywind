...
!yus Start of proposed change. v7.01 13-Sept-2012
   
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Include outputs associated with the TMDs   
...
! This code was generated by Write_ChckOutLst.m at 30-Jan-2012 12:30:08.
   CHARACTER( 9),PARAMETER  :: ValidParamAry(1122) =  (/ &                         ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               ...
                               "TIPSPDRAT",                                                                         &
							   "TMDXAXN  ","TMDXAXT  ","TMDXDXN  ","TMDXDXT  ","TMDXVXN  ","TMDXVXT  ",             &
							   "TMDYAYN  ","TMDYAYT  ","TMDYDYN  ","TMDYDYT  ","TMDYVYN  ","TMDYVYT  ",             &
   ...
   CHARACTER(10),PARAMETER  :: ParamUnitsAry(1122) =  (/ &                         ! This lists the units corresponding to the allowed parameters
                               ...
                               "(deg)     ","(deg)     ","(deg)     ","(deg)     ","(deg)     ","(deg)     ","(deg)     ", &
                               "(-)       ",                                                                               &
							   "(m/sec^2) ","(m/sec^2) ","(m)       ","(m)       ","(m/sec)   ","(m/sec)   ",              &
							   "(m/sec^2) ","(m/sec^2) ","(m)       ","(m)       ","(m/sec)   ","(m/sec)   ",              &
							   "(m/s)     ","(-)       ","(m)       ","(m)       ","(deg)     ","(deg)     ",              &
...
!yus End of proposed change. v7.01 13-Sept-2012
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Use the TMD module as well
USE                             TMD
!mal End of proposed change.  v6.10a-mal  1-Mar-2009.
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Include TmdX and TmdY control switches and time to start control.

   ! TmdXCMode - TmdX control mode.

CALL ReadIVar ( UnIn, PriFile, TmdXCMode, 'TmdXCMode', 'TmdX control mode' )
...
ENDIF
   ...
   ! TTmdXCOn - Time to enable TmdX control.

CALL ReadRVar ( UnIn, PriFile, TTmdXCOn, 'TTmdXCOn', 'Time to enable TmdX control' )
...
ENDIF
   ...
   ! TmdYCMode - TmdY control mode.

CALL ReadIVar ( UnIn, PriFile, TmdYCMode, 'TmdYCMode', 'TmdY control mode' )
...
ENDIF
   ...
   ! TTmdYCOn - Time to enable TmdY control.

CALL ReadRVar ( UnIn, PriFile, TTmdYCOn, 'TTmdYCOn', 'Time to enable TmdY control' )
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Include feature flags for TmdX and TmdY

   ! TmdXDOF - TmdX DOF.

CALL ReadLVar ( UnIn, PriFile, TmdXDOF, 'TmdXDOF', 'TmdX DOF' )


   ! TmdYDOF - TmdX DOF.

CALL ReadLVar ( UnIn, PriFile, TmdYDOF, 'TmdYDOF', 'TmdY DOF' )
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Initial displacements, stiffnesses, and dampings of TmdX and TmdY


   ! TmdXDsp - Initial TmdX displacement.

CALL ReadRVar ( UnIn, PriFile, TmdXDsp, 'TmdXDsp', 'TmdX initial or fixed displacement' )


   ! TmdYDsp - Initial TmdY displacement.

CALL ReadRVar ( UnIn, PriFile, TmdYDsp, 'TmdYDsp', 'TmdY initial or fixed displacement' )
...
!mal include the switch for tmdx location, either nacelle or platform

   ! TmdXLoc - TmdX location.

CALL ReadIVar ( UnIn, PriFile, TmdXLoc, 'TmdXLoc', 'TmdX location' )
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Reference locations of the TMDs


   ! TmdXRefxnt - Downwind distance from tower-top or platform ref to TmdX.

CALL ReadRVar ( UnIn, PriFile, TmdXRefxnt, 'TmdXRefxnt', 'Reference downwind distance from tower-top or platform ref to TmdX' )


   ! TmdXRefynt - Lateral  distance from tower-top or platform ref to TmdX.

CALL ReadRVar ( UnIn, PriFile, TmdXRefynt, 'TmdXRefynt', 'Reference Lateral distance from tower-top or platform ref to TmdX' )


   ! TmdXRefznt - Vertical distance from tower-top or platform ref to TmdX.

CALL ReadRVar ( UnIn, PriFile, TmdXRefznt, 'TmdXRefznt', 'Reference Vertical distance from tower-top or platform ref to TmdX' )

!mal Start of proposed change.  v7.10a-mal  18-July-2012.
!mal include orientation angle of TmdX

   ! TmdXAngle  - Angle that TmdX displacement direction is rotated about the vertical axis.

CALL ReadRVar ( UnIn, PriFile, TmdXAngle, 'TmdXAngle', 'Angle that TmdX displacement direction is rotated about the vertical axis' )

!mal End of proposed change.  v7.10a-mal  18-July-2012.

!mal Start of proposed change.  v6.40a-mal  10-Oct-2009.
!mal include the switch for tmdy location, either nacelle or platform

   ! TmdYLoc - TmdY location.

CALL ReadIVar ( UnIn, PriFile, TmdYLoc, 'TmdYLoc', 'TmdY location' )
...
!mal End of proposed change.  v6.40a-mal  10-Oct-2009.
   ...
   ! TmdYRefxnt - Downwind distance from tower-top or platform ref to TmdY.

CALL ReadRVar ( UnIn, PriFile, TmdYRefxnt, 'TmdYRefxnt', 'Reference Downwind distance from tower-top or platform ref to TmdY' )


   ! TmdYRefynt - Lateral  distance from tower-top or platform ref to TmdY.

CALL ReadRVar ( UnIn, PriFile, TmdYRefynt, 'TmdYRefynt', 'Reference Lateral  distance from tower-top or platform ref to TmdY' )


   ! TmdYRefznt - Vertical distance from tower-top or platform ref to TmdY.

CALL ReadRVar ( UnIn, PriFile, TmdYRefznt, 'TmdYRefznt', 'Reference Vertical distance from tower-top or platform ref to TmdY' )


!mal Start of proposed change.  v7.10a-mal  18-July-2012.
!mal include orientation angle of TmdY

   ! TmdYAngle  - Angle that TmdY displacement direction is rotated about the vertical axis.

CALL ReadRVar ( UnIn, PriFile, TmdYAngle, 'TmdYAngle', 'Angle that TmdY displacement direction is rotated about the vertical axis' )
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Tmd mass properties


   ! TmdXMass - TmdX mass.

CALL ReadRVar ( UnIn, PriFile, TmdXMass, 'TmdXMass', 'TmdX mass' )

IF ( TmdXMass < 0.0 )  CALL Abort ( ' TmdXMass must not be negative.' )
...
CALL ReadRVar ( UnIn, PriFile, TmdYMass, 'TmdYMass', 'TmdY mass' )

IF ( TmdYMass < 0.0 )  CALL Abort ( ' TmdYMass must not be negative.' )
...
!mal Start of proposed change.  v6.10a-mal  14-May-2009.
!mal tmd inputs also change skipcomment to readcom and abort to progabort
...
CALL ReadCom ( UnIn, PriFile, 'TMD parameters'  )


   ! TmdXSpr - Initial TmdX spring stiffness.

CALL ReadRVar ( UnIn, PriFile, TmdXSpr, 'TmdXSpr', 'TmdX initial or fixed spring stiffness' )

IF ( TmdXSpr < 0.0 )  CALL ProgAbort ( ' TmdXSpr must not be negative.' )


   ! TmdXDamp - Initial TmdX damping.

CALL ReadRVar ( UnIn, PriFile, TmdXDamp, 'TmdXDamp', 'TmdX initial or fixed damping' )

IF ( TmdXDamp < 0.0 )  CALL ProgAbort ( ' TmdXDamp must not be negative.' )


!mal Start of proposed change.  v6.20a-mal  23-July-2009.
!mal external force variables
   ! TmdXFext - TmdX external force.

CALL ReadRVar ( UnIn, PriFile, TmdXFext, 'TmdXFext', 'TmdX external force' )

!mal End of proposed change.  v6.20a-mal  23-July-2009.


!mal Start of proposed change.  v6.30a-mal  29-July-2009.
!mal load stop parameters too

   ! TmdXDWSP - TmdX downwind distance to downwind stop position (m) [measured from TmdXRefxnt]

CALL ReadRVar ( UnIn, PriFile, TmdXDWSP, 'TmdXDWSP', 'TmdX downwind distance to downwind stop position (m) [measured from TmdXRefxnt]' )

   ! TmdXDWSP - TmdX downwind distance to upwind stop position (m) [measured from TmdXRefxnt]

CALL ReadRVar ( UnIn, PriFile, TmdXUWSP, 'TmdXUWSP', 'TmdX downwind distance to upwind stop position (m) [measured from TmdXRefxnt]' )

   ! TmdXSSpr - Initial TmdX stop spring stiffness.

CALL ReadRVar ( UnIn, PriFile, TmdXSSpr, 'TmdXSSpr', 'TmdX initial or fixed stop spring stiffness' )

IF ( TmdXSSpr < 0.0 )  CALL ProgAbort ( ' TmdXSSpr must not be negative.' )

   ! TmdXSDamp - Initial TmdX stop damping.

CALL ReadRVar ( UnIn, PriFile, TmdXSDamp, 'TmdXSDamp', 'TmdX initial or fixed stop damping' )
...
!mal End of proposed change.  v6.30a-mal  29-July-2009.
   ...
   ! TmdYSpr - Initial TmdY spring stiffness.

CALL ReadRVar ( UnIn, PriFile, TmdYSpr, 'TmdYSpr', 'TmdY initial or fixed spring stiffness' )

IF ( TmdYSpr < 0.0 )  CALL ProgAbort ( ' TmdYSpr must not be negative.' )


   ! TmdYDamp - Initial TmdY damping.

CALL ReadRVar ( UnIn, PriFile, TmdYDamp, 'TmdYDamp', 'TmdY initial or fixed damping' )

IF ( TmdYDamp < 0.0 )  CALL ProgAbort ( ' TmdYDamp must not be negative.' )


!mal Start of proposed change.  v6.20a-mal  23-July-2009.
!mal external force variables
   ! TmdYFext - TmdY external force.

CALL ReadRVar ( UnIn, PriFile, TmdYFext, 'TmdYFext', 'TmdY external force' )
...
!mal tmdy stops
   ...
   ! TmdYPLSP - TmdY positive lateral stop position (m) [measured from TmdYRefynt]

CALL ReadRVar ( UnIn, PriFile, TmdYPLSP, 'TmdYPLSP', 'TmdY positive lateral stop position (m) [measured from TmdYRefynt]' )

   ! TmdYNLSP - TmdY negative lateral stop position (m) [measured from TmdYRefynt]

CALL ReadRVar ( UnIn, PriFile, TmdYNLSP, 'TmdYNLSP', 'TmdY negative lateral stop position (m) [measured from TmdYRefynt]' )

   ! TmdYSSpr - Initial TmdY stop spring stiffness.

CALL ReadRVar ( UnIn, PriFile, TmdYSSpr, 'TmdYSSpr', 'TmdY initial or fixed stop spring stiffness' )

IF ( TmdYSSpr < 0.0 )  CALL ProgAbort ( ' TmdYSSpr must not be negative.' )

   ! TmdYSDamp - Initial TmdY stop damping.

CALL ReadRVar ( UnIn, PriFile, TmdYSDamp, 'TmdYSDamp', 'TmdY initial or fixed stop damping' )
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Number of DOFs increases due to two TMDs
IF ( NumBl == 2 )  THEN
!remove6.10a   NDOF = 22
   NDOF = 24
ELSE
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal initialize some TMD parameters
TmdXDspInit = TmdXDsp
TmdXSprInit = TmdXSpr
...
!mal Start of proposed change.  v6.20a-mal  23-July-2009.
!mal Add in external force variables
...
!mal Start of proposed change.  v6.10a-mal  1-Mar-2009.
!mal Also note TMD DOFs if enabled.
